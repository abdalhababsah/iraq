...
class AdminController extends Controller
{
    ...
    {
        $candidate->load(['user', 'constituency']);
        $constituencies = Constituency::all();
        return view('dashboard.admin.candidates.edit', compact('candidate', 'constituencies'));
    }
    ...
    public function debugExcelColumns(Request $request)
    {
        ...
        try {
            ...
            $debugInfo = [
                ...
                'expected_columns' => [
                    'first_name', 'last_name', 'email', 'constituency_id', 
                    'party_bloc_name', 'phone', 'biography'
                ]
            ];
