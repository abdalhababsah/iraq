...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="profile-user position-relative"
                        style="height: 300px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); overflow: hidden; border-radius: 8px;">
                        @if ($candidate->profile_banner_image)
                            <img src="{{ $candidate->profile_banner_image_url }}" alt="صورة الغلاف" class="w-100 h-100"
                    ...
                    <div class="row align-items-end">
                        <div class="col-sm">
                            <div class="d-flex align-items-end mt-3 mt-sm-0">
                                            ...
                                            <div class="position-absolute bottom-0 end-0">
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-sm btn-primary rounded-circle"
                                                        id="profile-upload-btn" style="width: 35px; height: 35px;">
                                ...
                                <div class="flex-grow-1">
                                    <div class="mt-10">
                                        <h5 class="font-size-18 mb-1" id="candidate-name">{{ $candidate->user->full_name }}
                                        </h5>
                                        <p class="text-muted font-size-14 mb-2" id="candidate-position">
                                            {{ $candidate->current_position ?? 'مرشح للانتخابات' }}</p>
                                        <div class="d-flex flex-wrap gap-2 mb-2">
                                            <span
                                                class="badge bg-primary-subtle text-primary">{{ $candidate->constituency->name }}</span>
                                            <span
                                                class="badge bg-success-subtle text-success">{{ $candidate->party_bloc_name }}</span>
                                            @if ($candidate->list_number)
                                                <span class="badge bg-info-subtle text-info">رقم القائمة:
                                                    {{ $candidate->list_number }}</span>
                                            @endif
                                            @if ($candidate->serial_number)
                                                <span class="badge bg-warning-subtle text-warning">الرقم التسلسلي:
                                                    {{ $candidate->serial_number }}</span>
                                            @endif
                                        </div>
                                        @if ($candidate->campaign_slogan)
                                            <p class="text-muted font-size-13 fst-italic">
                                                "{{ $candidate->campaign_slogan }}"</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-auto">
                            <div class="d-flex align-items-start justify-content-end gap-2 mb-2">
                                @if (auth()->user()->id === $candidate->user_id || auth()->user()->isAdmin())
                                    <div>
                                        <button type="button" class="btn btn-success" id="toggle-edit-btn"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a class="dropdown-item" href="#"><i
                                                        class="mdi mdi-share me-2"></i>مشاركة الملف</a></li>
                                            <li><a class="dropdown-item" href="#"><i
                                                        class="mdi mdi-download me-2"></i>تحميل السيرة</a></li>
                    ...
                    <div class="card bg-transparent shadow-none">
                        <div class="card-body">
                            <ul class="nav nav-tabs-custom card-header-tabs border-top mt-2" id="pills-tab"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link px-3" data-bs-toggle="tab" href="#education"
                                        role="tab">المؤهلات العلمية</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link px-3" data-bs-toggle="tab" href="#experience"
                                        role="tab">الخبرة والإنجازات</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <form id="candidate-form" action="{{ route('admin.candidates.update', $candidate) }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                @method('PUT')

                <!-- Hidden file inputs -->
                <input type="file" id="profile_upload" name="profile_image" accept="image/*" style="display: none;"
                    onchange="uploadImage(this, 'profile')">
                <input type="file" id="banner_upload" name="profile_banner_image" accept="image/*"
                    style="display: none;" onchange="console.log('Banner file selected'); uploadImage(this, 'banner')">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-4">
                                                    ...
                                                    <select class="form-select" name="constituency_id">
                                                        @foreach ($constituencies as $constituency)
                                                            <option value="{{ $constituency->id }}"
                                                                {{ $candidate->constituency_id == $constituency->id ? 'selected' : '' }}>
                                                                {{ $constituency->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="edit-mode" style="display: none;">
                                                    <input type="text" class="form-control" name="party_bloc_name"
                                                        value="{{ $candidate->party_bloc_name }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                ...
                                                <div class="view-mode">
                                                    <p class="mb-0">{{ $candidate->list_number ?? 'غير محدد' }}</p>
                                                </div>
                                                <div class="edit-mode" style="display: none;">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="view-mode">
                                                    <p class="mb-0">{{ $candidate->serial_number ?? 'غير محدد' }}</p>
                                                </div>
                                                <div class="edit-mode" style="display: none;">
                                        ...
                                        <div class="pt-3">
                                            ...
                                            <div class="text-muted">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="view-mode">
                                                        <p class="mb-0 fst-italic">
                                                            {{ $candidate->campaign_slogan ? '"' . $candidate->campaign_slogan . '"' : 'غير محدد' }}
                                                        </p>
                                                    </div>
                                                    <div class="edit-mode" style="display: none;">
                                                        <input type="text" class="form-control" name="campaign_slogan"
                                                            value="{{ $candidate->campaign_slogan }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="view-mode">
                                                        <p class="mb-0">
                                                            {{ $candidate->voter_promises ? nl2br(e($candidate->voter_promises)) : 'غير محدد' }}
                                                        </p>
                                                    </div>
                                                    <div class="edit-mode" style="display: none;">
                                                ...
                                                <div class="edit-mode" style="display: none;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="url" class="form-control"
                                                                name="instagram_link"
                                                                value="{{ $candidate->instagram_link }}"
                                        ...
                                        @forelse($candidate->education as $edu)
                                            <div class="education-item border-bottom pb-3 mb-3"
                                                ...
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-1">{{ $edu->degree }} -
                                                            {{ $edu->field_of_study }}</h6>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="#"
                                                                        onclick="editEducation({{ $edu->id }})">تعديل</a>
                                                                </li>
                                                                <li><a class="dropdown-item text-danger" href="#"
                                                                        onclick="deleteEducation({{ $edu->id }})">حذف</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    @endif
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="pb-3">
                                            ...
                                            <div class="text-muted">
                                                <div class="view-mode">
                                                    <p class="mb-2">
                                                        {{ $candidate->experience ? nl2br(e($candidate->experience)) : 'غير محدد' }}
                                                    </p>
                                                </div>
                                                <div class="edit-mode" style="display: none;">
                                                        ...
                                                        <div class="achievements-list">
                                                            @foreach (explode("\n", $candidate->achievements) as $achievement)
                                                                @if (trim($achievement))
                                                                    <div class="py-1">
                                                                        <i
                                                                            class="mdi mdi-check-circle me-2 text-success"></i>{{ trim($achievement) }}
                                                                    </div>
                                                                @endif
                                                            @endforeach
                                                        </div>
                                        ...
                                        <div class="pt-3">
                                            ...
                                            <div class="text-muted">
                                                <div class="view-mode">
                                                    <p class="mb-2">
                                                        {{ $candidate->additional_info ? nl2br(e($candidate->additional_info)) : 'غير محدد' }}
                                                    </p>
                                                </div>
                                                <div class="edit-mode" style="display: none;">
                                        ...
                                        <tbody>
                                            ...
                                            @if ($candidate->serial_number)
                                                <tr>
                                                    ...
                                                    <td class="text-muted">{{ $candidate->serial_number }}</td>
                                                </tr>
                                            @endif
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="view-mode">
                                        <div class="d-flex flex-wrap gap-2 font-size-14">
                                            @foreach (explode('،', $candidate->skills) as $skill)
                                                @if (trim($skill))
                                                    <span
                                                        class="badge bg-primary-subtle text-primary">{{ trim($skill) }}</span>
                                                @endif
                                            @endforeach
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row text-center">
                                    <div class="col-12">
                                        <h4 class="mb-1 text-primary" id="education-count">
                                            {{ $candidate->education->count() }}</h4>
                ...
                <form id="education-form" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="education-institution" name="institution"
                                required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="education-start-year"
                                        name="start_year" min="1950" max="{{ date('Y') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">سنة الانتهاء</label>
                                    <input type="number" class="form-control" id="education-end-year" name="end_year"
                                        min="1950" max="{{ date('Y') }}">
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @if (session('education_edit'))
                ...
                document.getElementById('education-form').action =
                    '{{ route('admin.candidates.education.update', ['candidate' => $candidate, 'education' => '__ID__']) }}'
                    .replace('__ID__', educationData.id);
        ...
        function editEducation(id) {
            ...
            window.location.href =
                '{{ route('admin.candidates.education.edit', ['candidate' => $candidate, 'education' => '__ID__']) }}'
                .replace('__ID__', id);
        }
        ...
        function deleteEducation(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = 'POST';
                    form.action =
                        '{{ route('admin.candidates.education.delete', ['candidate' => $candidate, 'education' => '__ID__']) }}'
                        .replace('__ID__', id);
