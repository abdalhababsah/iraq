                       ...
                       <div class="card-body">
                           <div class="help-item mb-3">
                               ...
                               <p class="text-muted font-size-13 mb-0">
                                   ...
                                   الكتلة/الحزب، رقم الهاتف، الرقم التسلسلي، والسيرة الذاتية
                               </p>
                           </div>
                           <div class="help-item mb-3">
       ...
       <div class="row">
           <div class="col-md-6">
               ...
               <table class="table table-sm">
                   ...
                   <tr><td><strong>الرقم التسلسلي:</strong></td><td>${formData.get('serial_number')}</td></tr>
               </table>
           </div>
           <div class="col-md-6">
...
document.getElementById('candidate-form').addEventListener('submit', function(e) {
    const requiredFields = ['first_name', 'last_name', 'email', 'password', 'password_confirmation', 'phone', 'constituency_id', 'party_bloc_name', 'serial_number', 'biography'];
   let isValid = true;
