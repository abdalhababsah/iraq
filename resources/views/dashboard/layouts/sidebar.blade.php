    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <div class="card sidebar-alert shadow-none text-center mx-4 mb-0 mt-5">
                <div class="card-body">
                    <img src="{{ asset('dash/assets/images/giftbox.png') }}" alt="">
                    <div class="mt-4">
                        <h5 class="alertcard-title font-size-16">نظام إدارة انتخابي متطور</h5>
                        <p class="font-size-13 text-body">نظام شامل لإدارة المرشحين والدوائر الانتخابية بكفاءة عالية</p>
                        <a href="#!" class="btn btn-primary mt-2">المزيد من المعلومات</a>
                    </div>
                </div>
            </div>
        </div>
