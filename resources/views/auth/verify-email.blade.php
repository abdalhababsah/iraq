...
<head>
    <meta charset="utf-8" />
    <title>تأكيد البريد الإلكتروني | نظام إدارة الانتخابات</title>
                                ...
                                <div class="auth-content my-auto">
                                    <div class="text-center mb-4">
                                        <div class="avatar-md mx-auto">
                                            <div class="avatar-title rounded-circle bg-light">
                                                <i class="bx bxs-envelope font-size-24 text-primary"></i>
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <div class="text-center">
                                        <h5 class="mb-0">تأكيد البريد الإلكتروني</h5>
                                        <p class="text-muted mt-2">شكراً لك على التسجيل! قبل البدء، يرجى تأكيد عنوان بريدك الإلكتروني بالضغط على الرابط الذي أرسلناه إليك للتو.</p>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <form method="POST" action="{{ route('verification.send') }}" class="d-inline">
                                            @csrf
                                            <button type="submit" class="btn btn-primary w-100 waves-effect waves-light mb-3">
                                                <i class="mdi mdi-email-send-outline me-2"></i>إعادة إرسال رسالة التأكيد
                                            </button>
                                        </form>

                                        <form method="POST" action="{{ route('logout') }}" class="d-inline">
                                            @csrf
                                            <button type="submit" class="btn btn-outline-secondary w-100 waves-effect">
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="text-muted mb-0">لم تستلم الرسالة؟ تحقق من مجلد الرسائل غير المرغوب فيها</p>
                                    </div>
                                </div>
                                ...
                                <div class="p-0 p-sm-4 px-xl-0">
                                    <div class="testi-contain text-center text-white">
                                        ...
                                        <h4 class="mt-4 fw-medium lh-base text-white">
                                            "خطوة واحدة أخيرة لتأمين حسابك وحماية بياناتك في نظامنا الآمن"
                                        </h4>
                                        <div class="mt-4 pt-1 pb-5 mb-5">
                                            <h5 class="font-size-16 text-white">فريق الأمان</h5>
