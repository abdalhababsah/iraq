...
<head>
    <meta charset="utf-8" />
    <title>إعادة تعيين كلمة المرور | نظام إدارة الانتخابات</title>
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mt-2">أدخل كلمة المرور الجديدة لحسابك</p>
                                    </div>
                                    ...
                                    <form class="mt-4 pt-2" method="POST" action="{{ route('password.store') }}">
                                        ...
                                        <div class="form-floating form-floating-custom mb-4">
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                                   id="input-email" name="email" value="{{ old('email', $request->email) }}" 
                                        ...
                                        <div class="form-floating form-floating-custom mb-4 auth-pass-inputgroup">
                                            <input type="password" class="form-control pe-5 @error('password') is-invalid @enderror" 
                                                   id="password-input" name="password" placeholder="أدخل كلمة المرور الجديدة" required autocomplete="new-password">
                                            
                                            <button type="button" class="btn btn-link position-absolute h-100 end-0 top-0" id="password-addon">
                                                <i class="mdi mdi-eye-outline font-size-18 text-muted"></i>
                                            </button>
                                            <label for="password-input">كلمة المرور الجديدة</label>
                                            <div class="form-floating-icon">
                                        ...
                                        <div class="form-floating form-floating-custom mb-4 auth-pass-inputgroup">
                                            <input type="password" class="form-control pe-5 @error('password_confirmation') is-invalid @enderror" 
                                                   id="password-confirm-input" name="password_confirmation" placeholder="أكد كلمة المرور الجديدة" required autocomplete="new-password">
                                        ...
                                        <div class="mb-3">
                                            <button class="btn btn-primary w-100 waves-effect waves-light" type="submit">إعادة تعيين كلمة المرور</button>
                                        </div>
                                    </form>
                                ...
                                <div class="p-0 p-sm-4 px-xl-0">
                                    <div class="testi-contain text-center text-white">
                                        ...
                                        <h4 class="mt-4 fw-medium lh-base text-white">
                                            "أمان حسابك هو أولويتنا. قم بإعادة تعيين كلمة مرور قوية وآمنة"
                                        </h4>
